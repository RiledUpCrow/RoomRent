...
/**
 * Checks if the player has the room rented for specified time.
 * 
...
public class TimeCondition extends Condition {
	...
	public TimeCondition(String packName, String instruction) throws InstructionParseException {
	...
	public boolean check(String playerID) {
		return set.getTimeLeft(PlayerConverter.getPlayer(playerID)) >= time;
	}
